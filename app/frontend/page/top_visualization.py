...
def main():
    ...
    if response.status_code == 200:
        ...
        # Pair of Pie Chart and Bar Chart
        ...
        # Pair of Line Chart and Donut Chart
        col1, col2 = st.columns(2)
        with col1:
        ...
        # Pair of Histogram and Scatter Plot
        col1, col2 = st.columns(2)
        with col1:
        ...
        # Pair of Bubble Chart and Stacked Area Chart
        col1, col2 = st.columns(2)
        with col1:
        ...
        # Pair of Donut Chart and Box Plot
        col1, col2 = st.columns(2)
        with col1:
